...
public class ModifyProduct implements Initializable {
    ...
    @FXML
    private TableColumn<Part, Integer> modifyproductaddInventoryCol;
    ...
    @FXML
    private TextField modifyproductaddSearchtxt;
    ...
    @FXML
    private TableColumn<Part, Integer> modifyproductdeletePartIDCol;

    @FXML
    private TableColumn<Part, String> modifyproductdeletePartNameCol;
